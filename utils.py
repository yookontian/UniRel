...
class FreezeLayerCallback(TrainerCallback):
    ...
    def on_epoch_begin(self, args, state, control, **kwargs):
        if state.epoch == self.freeze_layer_epoch:
            # Assuming the model is attached to the trainer and has a BERT encoder
            model = kwargs['model']
            for param in model.bert.encoder.layer[self.freeze_layer_index].parameters():
